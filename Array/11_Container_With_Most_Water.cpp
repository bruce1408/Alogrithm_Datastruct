...
/**
 * 方法 1，利用两个指针来做，头指针left和尾指针right，每次面积就是尾指针减去头指针的差然后再乘以
 * 这两个指针所指向元素的最小值即可，如果头指针大于尾指针，那么尾指针--，否则头指针++，知道遍历停止
 * 
*/
...
/**
 * 方法 2，和方法 1的方法相同，但是根据逻辑来优化代码；如果数组中，高是相同的，那么面积只和长度有关
 * 比如[1,8,2,8,8],第二个1和最后1个8构成的面积最大，然后接下来到倒数的第二个8的时候，这个时候高都是
 * 8，但是长度却减小了，所以肯定面积比原来的要小很多，这个时候的面积不用考虑
*/
